        ...
        switch (turnCount) {
            ...
            case 2:
                if (corners.includes(currbtn)) {
                    //textbtn.textContent = "centerDefend";
                    let freeCorners = [];
    ...
    /*function adjacentEdgeCase() {
        for (var i = 0; i < winningCombinations.length; i++) {
            ...
            for (var pos of combination) {
                if (pos === compStartChoice) {
                    count++;
                }
                else if (pos === playerStartChoice) {
                    count++;
                } 
            }
            ...
            if (count === 2) {
                for (var pos of combination) {
                    if (pos !== playerStartChoice && pos !== compStartChoice) {
                        wrongCorners.push(pos);
                    }
                }
                if (compStartChoice === 1) { wrongCorners.push(9) }
                else if (compStartChoice === 3) { wrongCorners.push(7) }
                else if (compStartChoice === 7) { wrongCorners.push(3) }
                else if (compStartChoice === 9) { wrongCorners.push(1) }
                for (var corner of corners) {
                    if (corner !== playerStartChoice && !wrongCorners.includes(corner)) {
                        return corner;
                    }
                }
            }
